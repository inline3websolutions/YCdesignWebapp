...
const PortfolioGrid: React.FC<PortfolioGridProps> = ({ title, subtitle, projects, filter, viewAllLink }) => {
  ...
  return (
    <section ref={containerRef} id={filter.toLowerCase()} className="py-24 md:py-32 bg-zinc-50 dark:bg-[#09090B] border-t border-zinc-200 dark:border-white/5 relative overflow-hidden transition-colors duration-500">
      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        <div className="grid-header flex flex-col md:flex-row justify-between items-end mb-16">
          <div>
            <div className="flex items-center gap-3 mb-3">
                ...
                <h2 className="text-yc-yellow font-rubik tracking-widest uppercase text-xs font-bold">{subtitle}</h2>
            </div>
        ...
        >
                    ...
                    <div className="absolute bottom-0 left-0 w-full p-6 sm:p-8">
                        <div className="flex items-center gap-2 mb-3">
                            <span className="px-2 py-[2px] bg-yc-yellow text-black text-[10px] font-bold uppercase tracking-wider rounded-sm">
                             ...
                             <span className="text-zinc-300 dark:text-zinc-400 text-[10px] font-rubik uppercase tracking-wider">{project.engine}</span>
                        </div>
                        <h4 className="text-2xl sm:text-3xl font-syne font-bold text-white leading-tight">{project.title}</h4>
                    </div>
                </Link>
            ))}
            ...
            >
                ...
                <span className="text-zinc-500 dark:text-zinc-400 font-syne uppercase text-sm tracking-wider">View All</span>
            </Link>
        </div>
        ...
        <div className="md:hidden mt-6 text-center">
             <Link to={viewAllLink} className="inline-flex items-center gap-2 text-zinc-600 dark:text-zinc-500 text-xs uppercase tracking-widest font-rubik">
