...
const getCachedMotorcycles = unstable_cache(getMotorcycles, ['restored-moto-listing'], {
  tags: ['restored-moto', 'pages-restored-moto'],
})
    ...
    <div className="pt-24 pb-24">
      ...
      <div className="container mb-16">
        <div className="prose dark:prose-invert max-w-none">
          <h1>Restored Motorcycles</h1>
          <p className="text-lg">
            Explore our collection of beautifully restored classic motorcycles
          </p>
        </div>
      </div>
...
export function generateMetadata(): Metadata {
  return {
    title: 'Restored Motorcycles | YC Design',
    description: 'Explore our collection of beautifully restored classic motorcycles',
  }
}
